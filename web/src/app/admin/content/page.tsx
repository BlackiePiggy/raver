...
const HUB_CARDS = [
  ...
  {
    eyebrow: 'DJ Directory',
    title: 'DJ 目录',
    description: 'DJ 档案、媒体、proof 与链接资料统一在后台内处理。',
    bullets: ['目录中心支持快速定位', '新建与编辑共用同一套流程语义', '与审核链路保持连续'],
    href: '/admin/content/djs/catalog',
    tone: 'bg-[#f7c4c0]',
  },
  {
    eyebrow: 'News Directory',
    title: '资讯目录',
    ...
    >
      <section className="space-y-5">
        <div className="grid gap-4 lg:grid-cols-4">
          {[
            { label: 'Active Modules', value: '18', note: '核心内容模块' },
            ...
            <section className="admin-reference-dark-card p-6">
              ...
              <div className="mt-4 space-y-3">
                {[
                  ...
                  { href: '/admin/content/news', label: '资讯目录' },
                  { href: '/admin/content/labels', label: '厂牌目录' },
