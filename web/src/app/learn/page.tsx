    ...
    <div className="min-h-screen bg-bg-primary">
      ...
      <div className="pt-[44px] max-w-5xl mx-auto p-6 space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <Link href="/labels" className="rounded-xl border border-bg-tertiary bg-bg-secondary p-5 hover:border-primary-blue/50 transition-colors">
            <h2 className="text-xl font-semibold text-text-primary">厂牌</h2>
            <p className="text-sm text-text-secondary mt-2">查看全球电子音乐厂牌信息，并按粉丝数等维度排序。</p>
          </Link>
        </div>
      </div>
    </div>
