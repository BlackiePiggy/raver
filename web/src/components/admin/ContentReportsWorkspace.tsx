...
type ContentReportsWorkspaceProps = {
  embedded?: boolean;
};

export default function ContentReportsWorkspace({ embedded = false }: ContentReportsWorkspaceProps) {
  ...
  if (isLoading) {
    return embedded ? (
      <AdminContentLayout title="举报审核" eyebrow="Admin / Content Workspace / Reviews" description="加载中...">
