...
const getPhoneFrameDropShadow = (glowColor: string) => [
  ...
  `drop-shadow(0 0 38px ${glowColor})`,
].join(' ');
  ...
  return (
    ...
    >
      ...
      <div className="relative flex h-screen items-center justify-center overflow-hidden px-5">
        ...
        <motion.div
          aria-hidden="true"
          className="absolute h-[min(88vw,23.5rem)] w-[min(88vw,23.5rem)] rounded-full border border-lime-300/10 shadow-[0_0_140px_rgba(80,255,95,0.08)] md:h-[min(74vw,46rem)] md:w-[min(74vw,46rem)]"
          style={{ rotate }}
        />
        ...
        >
          ...
          >
            ...
            <img
              ...
              style={{ filter: getPhoneFrameDropShadow(item.glowColor) }}
            />
