...
actor MockWebFeatureService: WebFeatureService {
    ...
    func fetchLearnGenreDetail(id: String) async throws -> LearnGenreDetail {
        let details: [String: LearnGenreDetail] = [
            "house": LearnGenreDetail(
                ...
                soundCueTracks: [
                    LearnGenreSoundCueTrack(
                        ...
                        spotifyUrl: "https://open.spotify.com/search/Your%20Love%20Frankie%20Knuckles",
                        appleMusicUrl: nil,
                        neteaseUrl: nil,
                        soundcloudUrl: nil,
                        beatportUrl: nil
                ...
                era: "Early 1980s",
                bpm: "118-130",
                backgroundImageURL: "https://images.unsplash.com/photo-1492684223066-81342ee5ff30?auto=format&fit=crop&w=1800&q=80",
                spotifyTrackURL: nil,
                wikipediaURL: nil,
            ...
            "deep-house": LearnGenreDetail(
                ...
                era: "Mid 1980s",
                bpm: "110-125",
                backgroundImageURL: "https://images.unsplash.com/photo-1500530855697-b586d89ba3ee?auto=format&fit=crop&w=1800&q=80",
                spotifyTrackURL: nil,
                wikipediaURL: nil,
            ...
            "techno": LearnGenreDetail(
                ...
                soundCueTracks: [
                    LearnGenreSoundCueTrack(
                        title: "The Bells",
                        artist: "Jeff Mills",
                        spotifyUrl: "https://open.spotify.com/search/The%20Bells%20Jeff%20Mills",
                        appleMusicUrl: nil,
                        neteaseUrl: nil,
                        soundcloudUrl: nil,
                        beatportUrl: nil
                ...
                era: "Mid 1980s",
                bpm: "120-140",
                backgroundImageURL: "https://images.unsplash.com/photo-1514525253161-7a46d19cd819?auto=format&fit=crop&w=1800&q=80",
                spotifyTrackURL: nil,
                wikipediaURL: nil,
    ...
    private static func mockGlobalSearchItems(for query: String) -> [GlobalSearchItem] {
        [
            ...
            mockGlobalSearchItem(.rankingBoard, "ranking-dj-2025", query, "RaveHub Top DJs 2025", LT("年度榜单 · 2025", "Annual ranking · 2025", "年間ランキング · 2025"), LT("按 RaveHub 站内热度、收藏和打分综合生成。", "Generated from RaveHub popularity, saves, and ratings.", "RaveHub内の人気、保存、評価を総合して生成。"), LT("榜单", "Ranking", "ランキング"), 0.73, rankingYear: 2025),
            ...
            mockGlobalSearchItem(.rankingEntry, "ranking-dj-2025", query, "#3 Charlotte de Witte", LT("RaveHub Top DJs 2025", "RaveHub Top DJs 2025", "RaveHub Top DJs 2025"), LT("榜单条目会进入所属榜单详情。", "Ranking entries open their parent ranking board.", "ランキング項目は所属するランキング詳細を開きます。"), LT("榜单条目", "Ranking Entry", "ランキング項目"), 0.51, rankingYear: 2025)
        ]
    }
