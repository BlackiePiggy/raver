...
enum ChatCustomCardRegistry {
    static let all: [ChatCustomCardDefinition] = [
        .init(type: .event, displayNameCN: "活动卡片", displayNameEN: "Event Card", displayStyle: .coverMeta, routeHint: "eventDetail(eventID:)", requiredFields: ["eventID", "eventName", "venueDisplayAddress", "startAt"], status: .shareEntry),
        ...
        .init(type: .myCheckin, displayNameCN: "我的打卡卡片", displayNameEN: "My Check-in Card", displayStyle: .checkin, routeHint: "profile(.myCheckins(targetUserID:title:ownerDisplayName:))", requiredFields: ["userID", "displayName", "title"], status: .done),
