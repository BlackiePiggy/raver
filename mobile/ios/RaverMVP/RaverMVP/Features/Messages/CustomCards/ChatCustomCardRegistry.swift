...
enum ChatCustomCardRegistry {
    static let all: [ChatCustomCardDefinition] = [
        ...
        .init(type: .set, displayNameCN: "Set 卡片", displayNameEN: "Set Card", displayStyle: .coverMeta, routeHint: "setDetail(setID:)", requiredFields: ["setID", "setTitle"], status: .planning),
        .init(type: .news, displayNameCN: "资讯卡片", displayNameEN: "News Card", displayStyle: .coverMeta, routeHint: "newsDetail(articleID:)", requiredFields: ["articleID", "headline"], status: .planning),
        ...
        .init(type: .festival, displayNameCN: "Festival 卡片", displayNameEN: "Festival Card", displayStyle: .coverMeta, routeHint: "festivalDetail(festivalID:)", requiredFields: ["festivalID", "festivalName"], status: .planning),
        .init(type: .brand, displayNameCN: "Brand 卡片", displayNameEN: "Brand Card", displayStyle: .miniLink, routeHint: "brand detail route pending", requiredFields: ["brandID", "brandName"], status: .planning),
        .init(type: .label, displayNameCN: "Label 卡片", displayNameEN: "Label Card", displayStyle: .miniLink, routeHint: "labelDetail(labelID:)", requiredFields: ["labelID", "labelName"], status: .planning),
        ...
        .init(type: .rankingBoard, displayNameCN: "榜单卡片", displayNameEN: "Ranking Board Card", displayStyle: .miniLink, routeHint: "rankingBoardDetail(board:)", requiredFields: ["boardID", "boardName"], status: .planning),
