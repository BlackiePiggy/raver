...
final class DefaultChatController: ChatController {
    ...
    private let conversationType: OUICore.ConversationType
    ...
    private func sendText(text: String, to: String? = nil, conversationType: OUICore.ConversationType? = nil, quoteMessage: MessageInfo? = nil, completion: (([Section]) -> Void)?) {
