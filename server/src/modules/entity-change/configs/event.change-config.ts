...
export const eventChangePaths: Record<string, ChangePathConfig> = {
  ...
  'location.manualLocation': publicScalar('活动地址', 'Activity address', 'location', 95),
  'location.locationPoint': publicScalar('地图点位与场地展示', 'Map point and venue display', 'location', 90),
